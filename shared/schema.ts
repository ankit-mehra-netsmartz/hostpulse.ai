...
// Data Sources (Hospitable or Airbnb via Hospitable Connect)
export const dataSources = pgTable("data_sources", {
  ...
  provider: varchar("provider").notNull().default("hospitable"), // "hospitable" or "airbnb"
  name: varchar("name").notNull(),
  accessToken: text("access_token"), // For Hospitable OAuth
  refreshToken: text("refresh_token"), // For Hospitable OAuth
  tokenExpiresAt: timestamp("token_expires_at"), // For Hospitable OAuth
  externalCustomerId: varchar("external_customer_id"), // For Airbnb (Hospitable Connect customer ID)
...
export const listings = pgTable("listings", {
  ...
  autoAnalysisEnabled: boolean("auto_analysis_enabled")
    .notNull()
    .default(false),
...
export interface CategoryAnalysis {
  ...
  heroRecommendation?: {
    ...
    alternativePhotoIndex?: number | null;
...
export const listingAnalyses = pgTable("listing_analyses", {
  ...
  superhostStatusAnalysis: jsonb(
    "superhost_status_analysis",
  ...
  photoAnalysisStatus: varchar("photo_analysis_status")
  ...
  completedCategories: jsonb("completed_categories")
    .$type<string[]>()
    .default([]),
...
export const listingAnalysesRelations = relations(
  listingAnalyses,
  ({ one }) => ({
...
export const DEFAULT_THEMES = [
  {
    name: "Maintenance",
    icon: "🔧",
    description: "Issues related to property maintenance, repairs, and upkeep",
  },
  {
    name: "Cleanliness",
    icon: "✨",
    description: "Feedback about cleaning quality, hygiene, and tidiness",
  },
  {
    name: "Communication",
    icon: "💬",
    description: "Guest-host communication, responsiveness, and clarity",
  },
  {
    name: "Amenities",
    icon: "🏠",
    description: "Feedback about property features, appliances, and amenities",
  },
  {
    name: "Supplies",
    icon: "🧴",
    description: "Consumables, toiletries, kitchen supplies, and essentials",
  },
  {
    name: "Check-In Process",
    icon: "🔑",
    description: "Arrival experience, key access, and check-in instructions",
  },
  {
    name: "Access",
    icon: "🚪",
    description: "Entry points, parking, building access, and navigation",
  },
  {
    name: "Safety",
    icon: "🛡️",
    description:
      "Security concerns, smoke detectors, locks, and safety equipment",
  },
  {
    name: "Accessibility",
    icon: "♿",
    description:
      "Accessibility features and accommodations for guests with disabilities",
  },
  {
    name: "Pest Control",
    icon: "🐜",
    description: "Issues with insects, rodents, or other pests",
  },
  {
    name: "Unassigned",
    icon: "📋",
    description: "Tags that haven't been categorized into a specific theme yet",
  },
] as const;
...
export const insertListingAnalysisSchema = createInsertSchema(
  listingAnalyses,
).omit({
  id: true,
  createdAt: true,
...
export const updateListingAnalysisSchema = insertListingAnalysisSchema
  .partial()
  .omit({
    listingId: true,
    userId: true,
...
export const insertReviewsSummarySchema = createInsertSchema(
  reviewsSummaries,
).omit({
  id: true,
  createdAt: true,
...
export const changelogSettings = pgTable("changelog_settings", {
  ...
  suggestTime: varchar("suggest_time", { length: 10 })
    .notNull()
    .default("18:00"), // HH:MM format, Eastern time
...
export const insertChangelogSettingsSchema = createInsertSchema(
  changelogSettings,
).omit({
  id: true,
  createdAt: true,
...
export type InsertChangelogSettings = z.infer<
  typeof insertChangelogSettingsSchema
>;
...
export const procedureSteps = pgTable("procedure_steps", {
  ...
  requiresPhotoVerification: boolean("requires_photo_verification")
    .notNull()
    .default(false),
  photoVerificationMode: varchar("photo_verification_mode", { length: 20 })
    .notNull()
    .default("none"),
  requiresGpsVerification: boolean("requires_gps_verification")
    .notNull()
    .default(false),
...
export const procedureAssignmentsRelations = relations(
...
export const procedureCompletionsRelations = relations(
...
export const insertProcedureStepSchema = createInsertSchema(
  procedureSteps,
).omit({
  id: true,
  createdAt: true,
...
export const insertProcedureAssignmentSchema = createInsertSchema(
  procedureAssignments,
).omit({
  id: true,
  createdAt: true,
...
export const insertProcedureCompletionSchema = createInsertSchema(
  procedureCompletions,
).omit({
  id: true,
  createdAt: true,
...
export const insertStepCompletionSchema = createInsertSchema(
  stepCompletions,
).omit({
  id: true,
  createdAt: true,
...
export type InsertProcedureAssignment = z.infer<
  typeof insertProcedureAssignmentSchema
>;
export type ProcedureAssignment = typeof procedureAssignments.$inferSelect;

export type InsertProcedureCompletion = z.infer<
  typeof insertProcedureCompletionSchema
>;
...
export const procedureTemplateStepsRelations = relations(
  procedureTemplateSteps,
  ({ one }) => ({
...
export const procedureTemplatesRelations = relations(
  procedureTemplates,
  ({ many }) => ({
...
export const insertProcedureTemplateSchema = createInsertSchema(
  procedureTemplates,
).omit({
  id: true,
  createdAt: true,
...
export const insertProcedureTemplateStepSchema = createInsertSchema(
  procedureTemplateSteps,
).omit({
  id: true,
  createdAt: true,
...
export type InsertProcedureTemplate = z.infer<
  typeof insertProcedureTemplateSchema
>;
export type ProcedureTemplate = typeof procedureTemplates.$inferSelect;
export type InsertProcedureTemplateStep = z.infer<
  typeof insertProcedureTemplateStepSchema
>;
...
export const taskModuleItemsRelations = relations(
  taskModuleItems,
  ({ one }) => ({
...
export const insertTaskModuleItemSchema = createInsertSchema(
  taskModuleItems,
).omit({
  id: true,
  createdAt: true,
...
export const insertNotionConnectionSchema = createInsertSchema(
  notionConnections,
).omit({
  id: true,
  createdAt: true,
...
export type InsertNotionConnection = z.infer<
  typeof insertNotionConnectionSchema
>;
...
export const nudgeCampaignsRelations = relations(
  nudgeCampaigns,
  ({ many }) => ({
...
export const nudgeConversationsRelations = relations(
  nudgeConversations,
  ({ one, many }) => ({
...
// Insert schemas
export const insertNudgeCampaignSchema = createInsertSchema(
  nudgeCampaigns,
).omit({
  id: true,
  createdAt: true,
...
export const insertNudgeConversationSchema = createInsertSchema(
  nudgeConversations,
).omit({
  id: true,
  createdAt: true,
...
export type InsertNudgeConversation = z.infer<
  typeof insertNudgeConversationSchema
>;
...
export const cleaners = pgTable("cleaners", {
  ...
  reminderTiming: varchar("reminder_timing", { length: 20 })
    .notNull()
    .default("morning_of"), // night_before, morning_of
  reminderTime: varchar("reminder_time", { length: 5 })
    .notNull()
    .default("08:00"), // HH:mm format e.g. "08:00", "19:00"
  isActive: boolean("is_active").notNull().default(true),
  notes: text("notes"),
  createdAt: timestamp("created_at").defaultNow(),
  updatedAt: timestamp("updated_at").defaultNow(),
...
export const cleaningTasksRelations = relations(
  cleaningTasks,
  ({ one, many }) => ({
    cleaner: one(cleaners, {
...
export const cleaningTaskItemsRelations = relations(
  cleaningTaskItems,
  ({ one }) => ({
...
export const insertCleanerAssignmentSchema = createInsertSchema(
  cleanerAssignments,
).omit({
  id: true,
  createdAt: true,
...
export const insertCleaningTaskItemSchema = createInsertSchema(
  cleaningTaskItems,
).omit({
  id: true,
});
...
export type InsertCleanerAssignment = z.infer<
  typeof insertCleanerAssignmentSchema
>;
...
export type InsertCleaningTaskItem = z.infer<
  typeof insertCleaningTaskItemSchema
>;
...
export type NotificationTemplateType =
  (typeof NOTIFICATION_TEMPLATE_TYPES)[number];
...
export const insertReviewRemovalCaseSchema = createInsertSchema(
  reviewRemovalCases,
).omit({
  id: true,
  createdAt: true,
...
export type InsertReviewRemovalCase = z.infer<
  typeof insertReviewRemovalCaseSchema
>;
